...
Display( )
{
	...
	for (int c = 0; c < numcurves; c++) {
		float ver = 360. * c / numcurves;
		struct Curve curve;
		struct Point p0 = { 0., 0., 0. };
		struct Point p1 = { sin(ver), 3. * ((sin(20 * PI * Time) / 6) + 1.25), ((cos(ver *30)) / 4) - 3 };
		struct Point p2 = { sin(ver), 3. * ((sin(20 * PI * Time) / 6) - 1.25), ((cos(ver * 30)) / 4) - 3 };
		struct Point p3 = { 0, 2. * ((sin(2 * PI * Time) / 6) - 1.25), 1. };
		RotateY(&p0, 90., 0., 0., 0.);
		RotateY(&p1, 90., 0., 0., 0.);
		RotateY(&p2,90., 0., 0., 0.);
		RotateY(&p3, 90., 0., 0., 0.);
	...
	for (int c = 0; c < numcurves; c++) {
		...
		struct Curve curve;
		struct Point p0 = { 0., 0., 0. };
		struct Point p1 = { sin(ver), 3. * ((sin(20 * PI * Time) / 6) + 1.25), ((cos(ver * 30)) / 3) + 3 };
		struct Point p2 = { sin(ver), 3. * ((sin(20 * PI * Time) / 6) - 1.25), ((cos(ver * 30)) / 3) + 3 };
		struct Point p3 = { 0, 2. * ((sin(2 * PI * Time) / 6) - 1.25), -1.};
		RotateY(&p0, 90., 0., 0., 0.);
		RotateY(&p1, 90., 0., 0., 0.);
		RotateY(&p2, 90., 0., 0., 0.);
	...
	glTranslatef(.6, 1.15, .4);
	glScalef(.6, .6, .6);
	for (int c = 0; c < numcurves; c++) {
		float ver = 360. * c / numcurves;
		struct Curve curve;
		struct Point p0 = { 0., 0., 0. };
		struct Point p1 = { cos(ver), 2, (((cos(ver * 2)) / 2) - .5) * 1.8 };
		struct Point p2 = { cos(ver) , 1.5, (((cos(ver * 2)) / 2) - .5) * .8 };
