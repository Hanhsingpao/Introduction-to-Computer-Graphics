...
bool	frag_Shader = true;
bool	freez = true;
//float	Time;
float	ver_Time, frag_Time;
///////////////////////////
...
Display( )
{
	...
	Pattern->SetUniformVariable("uTime", ver_Time);
	Pattern->SetUniformVariable("ufTime", frag_Time);
	Pattern->SetUniformVariable("uv_s", vertex_Shader);
	Pattern->SetUniformVariable("ufrag_Shader", frag_Shader);
	Pattern->SetUniformVariable("uvert_Shader", Vs);
	//glCallList(BoxList);
	OsuSphere(3, 50, 50);
	Pattern->Use(0);
	/*
