...
//
//	Author:		Han-Hsing Pao(933651943)
...
InitLists( )
{
	...
	glNewList( BoxList, GL_COMPILE );
		...
		for (int i = 0; i < 100; i++) 
		{
			...
			glVertex3f(i * 0.01, 0., 1.0);
			glVertex3f((i + 1) * 0.01, 0., 1.0);
			glVertex3f((i + 1) * 0.01, 0., 0.);
		}
		glEnd( );
		...
		for (int i = 0; i < 100; i++)
		{
			glVertex3f(i * 0.005, i * 0.01, i * 0.005);
			glVertex3f((i + 1.0) * 0.005, (i + 1.0) * 0.01, i * 0.005);
			glVertex3f((i + 1.0) * 0.005, (i + 1.0) * 0.01, 1.0 - i * 0.005);
			glVertex3f(i * 0.005, i * 0.01, 1.0 - i * 0.005);
		}
		glEnd();
		...
		{
			glVertex3f(i * 0.005, i * 0.01, i * 0.005);
			glVertex3f(i * 0.005, (i + 1.0) * 0.01, (i + 1.0) * 0.005);
			glVertex3f(1.0 - i * 0.005, (i + 1.0) * 0.01, (i + 1.0) * 0.005);
			glVertex3f(1.0 - i * 0.005, i * 0.01,  i * 0.005);
		}
		glEnd();
		...
		for (int i = 0; i < 100; i++)
		{
			glVertex3f((i + 1.0) * 0.005, i * 0.01, i * 0.005);
			glVertex3f(1.0 - i * 0.005, (i + 1.0) * 0.01, i * 0.005);
			glVertex3f(1.0 - i * 0.005, (i + 1.0) * 0.01, 1.0 - i * 0.005);
			glVertex3f(1.0 - (i + 1.0) * 0.005, i * 0.01, 1.0 - i * 0.005);
		}
		glEnd();
		...
		for (int i = 0; i < 100; i++)
		{
			glVertex3f(i * 0.005, i * 0.01, (i + 1.0) * 0.005);
			glVertex3f(i * 0.005, (i + 1.0) * 0.01, 1.0 - i * 0.005);
			glVertex3f(1.0 - i * 0.005, (i + 1.0) * 0.01, 1.0 - i * 0.005);
			glVertex3f(1.0 - i * 0.005, i * 0.01, 1.0 - (i + 1.0) * 0.005);
		}
		glEnd();
